...
namespace JewelSystemBE.Migrations
{
    ...
    [Migration("20240605031503_create-database")]
            ...
            modelBuilder.Entity("JewelSystemBE.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = "df11cceb-241d-4383-8586-306e5a4c0b64",
                            CreatedAt = new DateTime(2024, 6, 5, 10, 15, 3, 235, DateTimeKind.Local).AddTicks(2455),
                            GemId = "1",
                            GemWeight = 5.0,
                            GoldId = "1",
                            GoldWeight = 45.0,
                        ...
                        new
                        {
                            ProductId = "13edf237-dacf-4e69-b322-2141c8aa6e64",
                            CreatedAt = new DateTime(2024, 6, 5, 10, 15, 3, 235, DateTimeKind.Local).AddTicks(2462),
                            GemId = "2",
                            GemWeight = 2.0,
                            GoldId = "2",
                            GoldWeight = 18.0,
                        ...
                        new
                        {
                            ProductId = "9ccc457b-40e4-4273-93dc-96cbeca924a9",
                            CreatedAt = new DateTime(2024, 6, 5, 10, 15, 3, 235, DateTimeKind.Local).AddTicks(2467),
                            GemId = "3",
                            GemWeight = 3.0,
                            GoldId = "3",
                            GoldWeight = 27.0,
                        ...
                        new
                        {
                            ProductId = "e9a26be3-77d5-48ca-ba45-5c263c4330ec",
                            CreatedAt = new DateTime(2024, 6, 5, 10, 15, 3, 235, DateTimeKind.Local).AddTicks(2471),
                            GemId = "4",
                            GemWeight = 1.5,
                            GoldId = "4",
                            GoldWeight = 13.5,
                        ...
                        new
                        {
                            ProductId = "2fc11df4-48b5-496a-b69d-54cd8e5c7486",
                            CreatedAt = new DateTime(2024, 6, 5, 10, 15, 3, 235, DateTimeKind.Local).AddTicks(2487),
                            GemId = "5",
                            GemWeight = 2.5,
                            GoldId = "5",
                            GoldWeight = 7.5,
                        ...
                        new
                        {
                            ProductId = "1de0eaf8-5331-4aba-8b7f-de93edf487e1",
                            CreatedAt = new DateTime(2024, 6, 5, 10, 15, 3, 235, DateTimeKind.Local).AddTicks(2491),
                            GemId = "1",
                            GemWeight = 4.0,
                            GoldId = "2",
                            GoldWeight = 21.0,
            ...
            modelBuilder.Entity("JewelSystemBE.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fullname = "User One",
                            Password = "$2a$11$iYfILgXC13Nkl5Ur4pIF0e/peePMQZCuIa7CWemEfu.t11B1drEy6",
                            Role = "Admin",
                            Username = "user1"
                        },
                        new
                        {
                            ...
                            Fullname = "User Two",
                            Password = "$2a$11$JqlOMhzkAIJ6pghi0lMNseWdHo8fAkrkeKIrmE4lXJyDWeBQAvO/m",
                            Role = "User",
                            Username = "user2"
                        },
                        new
                        {
                            ...
                            Fullname = "User Three",
                            Password = "$2a$11$d6VgojlZ/9LPHoIWsF0O2.cgQhkrbb3ipW00a007YcO6nqjd0zaUq",
                            Role = "User",
                            Username = "user3"
                        },
                        new
                        {
                            ...
                            Fullname = "User Four",
                            Password = "$2a$11$N9xRmFAiDrYyv2EzrYfcs.5YoS07hiuBNVl0R1wCo/GiQ7DofLjJC",
                            Role = "User",
                            Username = "user4"
                        },
                        new
                        {
                            ...
                            Fullname = "User Five",
                            Password = "$2a$11$jn5wPr1X2tS8ayDQpIsP9.6bZkE0l6l1vdXxnCCzZy98GzjLjZMn2",
                            Role = "User",
                            Username = "user5"
                        });
                });
