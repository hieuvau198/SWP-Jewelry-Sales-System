...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JewelBO.Customer", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.Discount", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.Gem", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.Gold", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.Invoice", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.InvoiceItem", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.Jewel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("JewelBO.Product", b =>
                {
            ...
            modelBuilder.Entity("JewelBO.User", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("JewelBO.Warranty", b =>
                {
                    b.Property<string>("WarrantyId")
                        .HasColumnType("nvarchar(450)")
                        .HasColumnName("warranty_id");
            ...
            modelBuilder.Entity("JewelBO.InvoiceItem", b =>
                {
                    b.HasOne("JewelBO.Invoice", "Invoice")
                        .WithMany()
                        .HasForeignKey("InvoiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JewelBO.Warranty", "Warranty")
                        .WithMany()
            ...
            modelBuilder.Entity("JewelBO.Product", b =>
                {
                    b.HasOne("JewelBO.Gem", "Gem")
                        .WithOne()
                        .HasForeignKey("JewelBO.Product", "GemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JewelBO.Gold", "Gold")
                        .WithMany()
