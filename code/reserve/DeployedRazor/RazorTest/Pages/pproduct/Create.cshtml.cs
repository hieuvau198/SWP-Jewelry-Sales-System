...
namespace RazorTest.Pages.pproduct
{
    public class CreateModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            ...
            Gems = await _apiService.GetAsync<List<Gem>>("https://jewelsystembe20240701213216.azurewebsites.net/api/gem") ?? new List<Gem>();
            Golds = await _apiService.GetAsync<List<Gold>>("https://jewelsystembe20240701213216.azurewebsites.net/api/gold") ?? new List<Gold>();
        }
