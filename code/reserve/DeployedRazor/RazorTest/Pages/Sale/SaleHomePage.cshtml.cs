...
namespace RazorTest.Pages.Sale
{
    public class SaleHomePageModel : PageModel
    {
        ...
        public const string UrlGetDiscounts = "https://jewelsystembe20240701213216.azurewebsites.net/api/discount\r\n";
        ...
        public async Task OnGetAsync(int currentPage = 1)
        {
            ...
            {
                allProducts = await _apiService.GetAsync<List<Product>>("https://jewelsystembe20240701213216.azurewebsites.net/api/product");
            }
