...
namespace RazorTest.Services
{
    public class InvoiceService
    {
        ...
        {
            return await _apiService.GetAsync<List<Invoice>>("https://hvjewel.azurewebsites.net/api/invoice");
        }

        public async Task<Invoice> GetInvoiceByIdAsync(string invoiceId)
        {
            return await _apiService.GetAsync<Invoice>($"https://hvjewel.azurewebsites.net/api/invoice/{invoiceId}");
        }

        public async Task<HttpResponseMessage> CreateInvoiceAsync(Invoice invoice)
        {
            return await _apiService.PostAsJsonAsync("https://hvjewel.azurewebsites.net/api/invoice", invoice);
        }

        public async Task<HttpResponseMessage> UpdateInvoiceAsync(Invoice invoice)
        {
            var url = "https://hvjewel.azurewebsites.net/api/invoice";
        ...
        {
            return await _apiService.DeleteAsync($"https://hvjewel.azurewebsites.net/api/invoice?invoiceId={invoiceId}");
        }
