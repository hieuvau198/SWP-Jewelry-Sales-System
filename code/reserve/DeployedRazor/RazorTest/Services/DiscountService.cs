...
namespace RazorTest.Services
{
    public class DiscountService
    {
        ...
        {
            return await _apiService.GetAsync<List<Discount>>("https://jewelsystembe20240701213216.azurewebsites.net/api/discount");
        }

        public async Task<Discount> GetDiscountByIdAsync(string discountId)
        {
            return await _apiService.GetAsync<Discount>($"https://jewelsystembe20240701213216.azurewebsites.net/api/discount/{discountId}");
        }

        public async Task<HttpResponseMessage> CreateDiscountAsync(Discount discount)
        {
            return await _apiService.PostAsJsonAsync("https://jewelsystembe20240701213216.azurewebsites.net/api/discount", discount);
        }

        public async Task<HttpResponseMessage> UpdateDiscountAsync(Discount discount)
        {
            var url = "https://jewelsystembe20240701213216.azurewebsites.net/api/discount";
        ...
        {
            return await _apiService.DeleteAsync($"https://jewelsystembe20240701213216.azurewebsites.net/api/discount/{discountId}");
        }
