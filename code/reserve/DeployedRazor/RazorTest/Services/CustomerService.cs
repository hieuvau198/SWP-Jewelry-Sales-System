...
namespace RazorTest.Services
{
    public class CustomerService
    {
        ...
        {
            return await _apiService.GetAsync<List<Customer>>("https://hvjewel.azurewebsites.net/api/customer");
        }

        public async Task<Customer> GetCustomerByIdAsync(string customerId)
        {
            return await _apiService.GetAsync<Customer>($"https://hvjewel.azurewebsites.net/api/customer/{customerId}");
        }

        public async Task<HttpResponseMessage> CreateCustomerAsync(Customer customer)
        {
            return await _apiService.PostAsJsonAsync("https://hvjewel.azurewebsites.net/api/customer", customer);
        }

        public async Task<HttpResponseMessage> UpdateCustomerAsync(Customer customer)
        {
            var url = "https://hvjewel.azurewebsites.net/api/customer";
        ...
        {
            return await _apiService.DeleteAsync($"https://hvjewel.azurewebsites.net/api/customer/{customerId}");
        }
